            ...
            <jsp:include page="../examiner-sidebar.jsp"></jsp:include> 
                <div class="main-content">
                    <div class="column px-4 py-4" style="background-color:#FFFFFF; overflow-y: scroll;">
                        ...
                        <form id ='myForm' action="${pageContext.request.contextPath}/F7LecturerServlet" method="post">
                        ...
                        <div class="p-3">
                            ...
                            <div class="is-flex is-justify-content-space-between p-4">
                                ...
                                <button class="button is-primary" type="submit" onclick="openConfirmModal(event)">Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="modal" id="confirmModal">
                ...
                <div class="modal-card">
                    ...
                    <footer class="modal-card-foot">
                        <button class="button is-success" onclick="submitForm()">Yes</button>
