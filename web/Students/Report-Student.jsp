<%-- 
    Document   : Report-Student
    Created on : May 2, 2024, 6:13:47 PM
    Author     : User
--%>
                    ...
                    <table class="">
                        <thead>
                            <tr style="border-bottom: 2px solid #ddd;">
                                ...
                                <th class="has-text-grey-light has-text-weight-semibold has-text-centered is-size-7">Report Tittle</th>
