                                    ...
                                    <div class="columns">
                                        <div class="column is-one-third">
                                            <div class="field">
                                                ...
                                                <div class="control">
                                                    <input class="input custom-input2" type="text" placeholder="Name" value="<%= ((Student) request.getAttribute("Student")).getsName() %>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="column is-one-third">
                                    ...
                                    <div class="columns">
                                        <div class="column is-one-third">
                                            <div class="field">
                                                ...
                                                <div class="control">
                                                    <input class="input custom-input2" type="text" placeholder="Course" value="<%= ((Student) request.getAttribute("Student")).getsCourse() %>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="column is-one-third">
                                            <div class="field">
                                                ...
                                                <div class="control">
                                                    <input class="input custom-input2" type="text" placeholder="Semester" value="<%= ((Student) request.getAttribute("Student")).getSemester() %>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
