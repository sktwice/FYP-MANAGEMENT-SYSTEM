        ...
        <div class="columns m-0 p-0 h-100">
            ...
            <div class="column px-6 py-4" style="background-color:#FFFFFF; overflow-y: scroll;">
                <div class="has-text-weight-semibold has-text-grey is-size-5 p-4" style="border-bottom: 1px solid #bdbdbd">
                    ...
                    <div class="columns is-multiline m-0 p-0">
                        ...
                        <div class="column is-10">
                            <div class="py-2">
                                <input class="px-4 py-2" type="text" placeholder="Full Name" style="width: 100%; border-radius: 6px; outline: none;">
                            </div>
                        </div>
                        <div class="column is-2" style="align-content: center">
                        ...
                        <div class="column is-10">
                            <div class="py-2">
                                <input class="px-4 py-2" type="text" placeholder="Student ID" style="width: 100%; border-radius: 6px; outline: none;">
                            </div>
                        </div>
                        <div class="column is-2" style="align-content: center">
                        ...
                        <div class="column is-10">
                            <div class="py-2">
                                <input class="px-4 py-2" type="text" placeholder="Programme" style="width: 100%; border-radius: 6px; outline: none;">
                            </div>
                        </div>
                         <div class="column is-2" style="align-content: center">
                        ...
                        <div class="column is-10">
                            <div class="py-2">
                                <input class="px-4 py-2" type="text" placeholder="Supervisor" style="width: 100%; border-radius: 6px;outline: none;">
                            </div>
                        </div>
                        <div class="column is-2" style="align-content: center">
                        ...
                        <div class="column is-10">
                            <div class="py-2">
                                <input class="px-4 py-2" type="text" placeholder="Title" style="width: 100%; border-radius: 6px; outline: none;">
                            </div>
                        </div>
                        <div class="column is-2" style="align-content: center">
                        ...
                        <div class="column is-10">
                            <div class="py-2">
                                <input class="px-4 py-2" type="date" placeholder="Date" style="width: 100%; border-radius: 6px; outline: none; border: 1px solid #ccc;">
                            </div>
                        </div>
                    </div>
                <div class="p-3">
                <table class="">
                    <thead>
                    <tr>
                        <th class="has-text-grey has-text-weight-semibold has-text-centered" style="border: 1px solid #dbdbdb;">Assessment Criteria</th>
                        <th class="has-text-grey has-text-weight-semibold has-text-centered" style="border: 1px solid #dbdbdb;">Weight (W)</th>
                        <th class="has-text-grey has-text-weight-semibold has-text-centered" style="border: 1px solid #dbdbdb;">Score (s) [1-10] (refer to F7 rubric)</th>
                        <th class="has-text-grey has-text-weight-semibold has-text-centered" style="border: 1px solid #dbdbdb;">Marks (W*S)</th>
                    </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td class="has-text-grey" data-label="Assessment Criteria" style="border: 1px solid #dbdbdb;">
                                <p class="has-text-weight-semibold is-size-7">1. Project Background and Problem</p>
                                <p class="is-size-7">(Appropriate working title, clear problem statement, well-defined project scope.)</p>
                            </td>
                            <td class="has-text-grey has-text-weight-semibold has-text-centered" data-label="Weight (W)" style="border: 1px solid #dbdbdb; align-content:center;">3</td>
                        ...
                        <tr>
                            ...
                            <td class="has-text-grey has-text-weight-semibold has-text-centered" data-label="Weight (W)" style="border: 1px solid #dbdbdb; align-content:center;">2</td>
                            <td class="has-text-centered" data-label="Score (s) [1-10]" style="border: 1px solid #dbdbdb; align-content:center;">
                                <div class="dropdown is-hoverable">
                                    <div class="dropdown-trigger">
                                        <button class="button is-white" style="border: 0.9px solid;" aria-haspopup="true" aria-controls="dropdown-menu3">
                        ...
                        <tr>
                            ...
                            <td class="has-text-grey has-text-weight-semibold has-text-centered" data-label="Weight (W)" style="border: 1px solid #dbdbdb; align-content:center;">1</td>
                            <td class="has-text-centered" data-label="Score (s) [1-10]" style="border: 1px solid #dbdbdb; align-content:center;">
                                <div class="dropdown is-hoverable">
                                    <div class="dropdown-trigger">
                                        <button class="button is-white" style="border: 0.9px solid;" aria-haspopup="true" aria-controls="dropdown-menu3">
                        ...
                        <tr>
                            ...
                            <td class="has-text-grey has-text-weight-semibold has-text-centered" data-label="Weight (W)" style="border: 1px solid #dbdbdb; align-content:center;">5</td>
                            <td class="has-text-centered" data-label="Score (s) [1-10]" style="border: 1px solid #dbdbdb; align-content:center;">
                                <div class="dropdown is-hoverable">
                                    <div class="dropdown-trigger">
                                        <button class="button is-white" style="border: 0.9px solid;" aria-haspopup="true" aria-controls="dropdown-menu3">
                        ...
                        <tr>
                            ...
                            <td class="has-text-grey has-text-weight-semibold has-text-centered" data-label="Weight (W)" style="border: 1px solid #dbdbdb; align-content:center;">6</td>
                            <td class="has-text-centered" data-label="Score (s) [1-10]" style="border: 1px solid #dbdbdb; align-content:center;">
                                <div class="dropdown is-hoverable">
                                    <div class="dropdown-trigger">
                                        <button class="button is-white" style="border: 0.9px solid;" aria-haspopup="true" aria-controls="dropdown-menu3">
                        ...
                        <tr>
                            <td class="has-text-grey" data-label="Assessment Criteria" style="border: 1px solid #dbdbdb;">
                                ...
                                <p class="is-size-7">(Supervisor Only)(This may include supervisory meetings (Project In-Progress Form- F3), supervisory independency, responsibilities, commitment, maturity, etc.)</p>
                            </td>
                            <td class="has-text-grey has-text-weight-semibold has-text-centered" data-label="Weight (W)" style="border: 1px solid #dbdbdb; align-content:center;">2</td>
                            <td class="has-text-centered" data-label="Score (s) [1-10]" style="border: 1px solid #dbdbdb; align-content:center;">
                                <div class="dropdown is-hoverable">
            ...
            <div class="p-3">
                <div class="pb-3 has-text-grey has-text-weight-semibold">CSP600 - PROJECT FORMULATION REPORT EVALUATION (F8) RUBRIC</div>
                <table class="">
                    <thead>
                    ...
                    <tbody>
                    <tr>
                        <td class="has-text-grey has-text-centered is-size-7 has-text-right-mobile" data-label="No">1</td>
                        <td class="has-text-grey is-size-7 has-text-right-mobile" data-label="Assessment Criteria">Depth of Knowledge</td>
                        <td class="has-text-grey is-size-7 has-text-right-mobile" data-label="Excellent (8-10)">
                            <ul>
                        ...
                        <td class="has-text-grey is-size-7 has-text-right-mobile" data-label="Good (6-7)">
                             <ul>
                        ...
                        <td class="has-text-grey is-size-7 has-text-right-mobile" data-label="Satisfactory (5)">
                            <ul>
                        ...
                        <td class="has-text-grey is-size-7 has-text-right-mobile" data-label="Poor (1-4)">
                            <ul>
                    ...
                    <tr>
                        <td class="has-text-grey has-text-centered is-size-7 has-text-right-mobile" data-label="No">2</td>
                        <td class="has-text-grey is-size-7 has-text-right-mobile" data-label="Assessment Criteria">Overall Organization of The Project Presentation</td>
                        <td class="has-text-grey is-size-7 has-text-right-mobile" data-label="Excellent (8-10)">
                            <ul>
                    ...
                    <tr>
                        <td class="has-text-grey has-text-centered is-size-7 has-text-right-mobile" data-label="No">3</td>
                        <td class="has-text-grey is-size-7 has-text-right-mobile" data-label="Assessment Criteria">Use Variety of Presentation Materials</td>
                        <td class="has-text-grey is-size-7 has-text-right-mobile" data-label="Excellent (8-10)">
                            <ul>
                    ...
                    <tr>
                        <td class="has-text-grey has-text-centered is-size-7 has-text-right-mobile" data-label="No">4</td>
                        <td class="has-text-grey is-size-7 has-text-right-mobile" data-label="Assessment Criteria">Delivery Skills</td>
                        <td class="has-text-grey is-size-7 has-text-right-mobile" data-label="Excellent (8-10)">
                            <ul>
