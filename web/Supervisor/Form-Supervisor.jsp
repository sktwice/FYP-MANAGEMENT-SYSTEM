                    ...
                    <div class="custom-border p-6 w-100">
                        ...
                        <div class="container">
                            ...
                            <ul style="border-bottom-color: #dbdbdb !important">
                                ...
                                <li data-target="tab-3" class="is-size-7"><a class="p-3 has-text-weight-semibold has-text-grey">Form 7-Formulation Presentation</a></li>
                                ...
                                <table class="">
                                    ...
                                    <c:forEach var="report" items="${listReportsF5}">
                                        <tr>
                                            ...
                                            <td class="has-text-grey has-text-weight-semibold is-size-7 has-text-centered has-text-right-mobile p-4" data-label="Actions" style="align-content:center;">
                                    ...
                                    <table class="">
                                        ...
                                        <c:forEach var="report" items="${listReports}">
                                            <tr>
                                                ...
                                                <td class="has-text-grey has-text-weight-semibold is-size-7 has-text-centered has-text-right-mobile p-4" style="align-content:center;" data-label="Student">${report.studentName}</td>
                                                <td class="has-text-grey has-text-weight-semibold is-size-7 has-text-centered has-text-right-mobile p-4" style="align-content:center;" data-label="Project Title">${report.projectTitle}</td>
                                                <td class="has-text-grey has-text-weight-semibold is-size-7 has-text-centered has-text-right-mobile p-4" style="align-content:center;" data-label="Report">
                                                ...
                                                <td class="has-text-grey has-text-weight-semibold is-size-7 has-text-centered has-text-right-mobile p-4" style="align-content:center;" data-label="Supervisor Name">${report.supervisorName}</td>
                                                <td class="has-text-grey has-text-weight-semibold is-size-7 has-text-centered has-text-right-mobile p-4" style="align-content:center;" data-label="Action">
                                ...
                                <table class="">
                                    ...
                                    <c:forEach var="report" items="${listReportsF8}">
                                        <tr>
                                            ...
                                            <td class="has-text-grey has-text-weight-semibold is-size-7 has-text-centered has-text-right-mobile p-4" style="align-content:center;" data-label="Supervisor Name">${report.supervisorName}</td>
                                            <td class="has-text-grey has-text-weight-semibold is-size-7 has-text-centered has-text-right-mobile p-4" style="align-content:center;" data-label="Action">
                                                <button class="button is-small is-info is-outlined" onclick="openModal2(${report.formtId})">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                            </td>
                                        </tr>
    ...
    <div class="modal-card">
        ...
        <section class="modal-card-body has-background-white">
            ...
            <div class="columns is-multiline m-0">
                ...
                <div class="column is-12 p-0" style="align-content: center">
    ...
    <div class="modal-card">
        ...
        <section class="modal-card-body has-background-white">
            ...
            <div class="columns is-multiline m-0">
                ...
                <div class="column is-full p-0">
                    <div class="py-2">
                        <input class="px-4 py-2" name="handoverDate" id="handoverDate" type="date" placeholder="" required
