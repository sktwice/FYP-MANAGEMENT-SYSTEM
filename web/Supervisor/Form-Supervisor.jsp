        ...
        <div class="custom-border p-6 w-100">
            ...
            <div class="p-3">
                <div class="is-flex is-justify-content-space-between pb-2">
                    ...
                    <a class="button is-custom3" href="../Supervisor/F1.jsp">
            ...
            <div class="p-3">
                <div class="is-flex is-justify-content-space-between pb-2">
                    ...
                    <a class="button is-custom3" href="../Supervisor/F5.jsp">
                        <span class="is-size-7 p-1">Open</span>
                        <span class="is-size-7 fas fa-arrow-up-right-from-square"></span>
                    </a>
                </div>
            ...
            <div class="p-3">
                <div class="is-flex is-justify-content-space-between pb-2">
                    ...
                    <a class="button is-custom3" href="../Supervisor/F6.jsp">
                        <span class="is-size-7 p-1">Open</span>
                        <span class="is-size-7 fas fa-arrow-up-right-from-square"></span>
                    </a>
                </div>
            ...
            <div class="p-3">
                <div class="is-flex is-justify-content-space-between pb-2">
                    ...
                    <a class="button is-custom3" href="../Supervisor/F7.jsp">
                        <span class="is-size-7 p-1">Open</span>
                        <span class="is-size-7 fas fa-arrow-up-right-from-square"></span>
                    </a>
                </div>
            ...
            <div class="p-3">
                <div class="is-flex is-justify-content-space-between pb-2">
                    ...
                    <a class="button is-custom3" href="../Supervisor/F8.jsp">
                        <span class="is-size-7 p-1">Open</span>
                        <span class="is-size-7 fas fa-arrow-up-right-from-square"></span>
                    </a>
                </div>
