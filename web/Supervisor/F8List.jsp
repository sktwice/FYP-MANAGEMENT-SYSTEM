                                        ...
                                        <tr>
                                            ...
                                            <td class="has-text-grey has-text-weight-semibold is-size-7 has-text-centered has-text-right-mobile p-4">
                                                <div class="is-flex is-justify-content-center">
                                                    <a class="button is-custom3 is-small" href="${pageContext.request.contextPath}/F8SupervisorServlet?studentId=${report.studentId}&formtId=${report.formtId}">Insert</a>
