                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td class="has-text-grey has-text-weight-semibold is-size-7 has-text-centered has-text-right-mobile p-4" 
                                        ...
                                        <div class="">
                                                <a href="${pageContext.request.contextPath}/ViewProposalPdfServlet?proposalId=<%= proposal.getProposalId() %>"  target="_blank" class="button is-success is-outlined is-small mr-1">
