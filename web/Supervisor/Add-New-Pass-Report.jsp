        ...
        <div class="content-wrapper">
            ...
            <div class="main-content">
                <div class="column px-6 py-3" style="background-color:#FFFFFF;">
                    ...
                    <form action="AddPastRepostSupervisor" method="post" enctype="multipart/form-data" class="pt-4">
                        ...
                        <div class="pt-3">
                            <div id="file-js-example" class="file has-name">
                                <label class="file-label">
                                    ...
                                    <span class="file-name has-text-grey is-size-">No file uploaded</span>
                                </label>
                            </div>
                        </div>
                        <div class="is-flex is-justify-content-space-between py-6">
                            <a class="button is-custom2" href="../Lecturers/Report-Lecturer.jsp">
                                <span class="has-text-weight-semibold is-size-7">Back</span>
                            </a>
                            <input class="button is-custom has-background-grey-dark has-text-white-bis is-size-7" type="submit" value="Submit">
                        </div>
                    </form>
                </div>
            </div>
