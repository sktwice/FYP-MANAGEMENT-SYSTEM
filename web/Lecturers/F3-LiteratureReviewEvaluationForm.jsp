                        ...
                        <table class="">
                            ...
                            <tr>
                                <td class="p-5" data-label="Assessment Criteria" style="border: 1px solid #dbdbdb;">
                                    <p class="has-text-weight-semibold is-size-7 has-text-grey-dark">Relevance and context</p>
                                    <p class="is-size-7 has-text-grey-dark">Relevance and context (Identify problems / issues / opportunities)</p>
                                </td>
                            ...
                            <tr>
                                <td class="p-5" data-label="Assessment Criteria" style="border: 1px solid #dbdbdb;">
                                    <p class="has-text-weight-semibold is-size-7 has-text-grey-dark">Knowledge of the field/sources</p>
                                    <p class="is-size-7 has-text-grey-dark">(Knowledge of the field/sources)</p>
                                </td>
