    ...
    <div class="columns m-0 p-0 h-100">
        ...
        <div class="column px-6 py-3" style="background-color:#FFFFFF; overflow-y: scroll;">
            ...
            <div class="is-flex is-justify-content-space-between px-3 py-5">
                ...
                <a href="${pageContext.request.contextPath}/Lecturer/UserProfile-Lecturer.jsp" class="button is-custom"><span class="has-text-weight-semibold is-size-7">Edit Profile</span></a>
            </div>
        </div>
    </div>
    <script>
