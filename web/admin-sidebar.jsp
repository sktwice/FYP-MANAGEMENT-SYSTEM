...
<div class="sidebar">
    ...
    <ul class="nav-list">
        ...
        <li><a href="Student-List.jsp"><i class="fa fa-user-graduate mx-2"></i> Student</a></li>
        <li><a href="Scope-Admin.jsp"><i class="fa fa-search mx-2"></i> Scope</a></li>
        <li><a href="StudentList-Supervision-Admin.jsp"><i class="fa fa-bullseye mx-2"></i> Supervision</a></li>
