 ...
 * @author User
 */
public class SupervisorUserProfileServlet extends HttpServlet {
    ...
    @Override
     protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("Supervisor/UserProfile-Supervisor.jsp");
