...
public class LecturerAddScope extends HttpServlet {
   ...
   protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect(request.getContextPath()+ "/ScopeList"); // Redirect to the scope list page or another page
    }
}
