...
public class F8Servlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Form8 form8 = new Form8(formtId2,handoverDate, proBackground, objective, significance, literature, proMethodology, presentReport, progressEvaluate, total2, comment2, role, agreement, date);
